...
public class EspectroTest {
	...
	@Test
	public void setTest() {
		Unidad unidad=(Unidad) new Espectro(Color.ROJO,new Posicion(10,5));
	...
	@Test
	public void ataque(){
		UnidadDeAtaque unidad=(UnidadDeAtaque) new Espectro(Color.AMARILLO,new Posicion(10,5));
	...
	public void recibirdanio(){
		Unidad unidad=(Unidad) new Espectro(Color.AMARILLO,new Posicion(10,5));
	...
	public void pasarTurno() {
		Ser ser = new Espectro(Color.AZUL,new Posicion(10,5));
